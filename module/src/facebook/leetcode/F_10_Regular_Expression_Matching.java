...
public class F_10_Regular_Expression_Matching {
    public boolean isMatch(String s, String p) {
        ...
        char d1 = p.charAt(0), d2 = '0'; //any init value except '*'for d2 will do
         ...
         if (d2 == '*') {
            ...
            if (compare(c1, d1)) {return isMatch(s.substring(1), p.substring(1));}
            else {return false;}
        }
    }
    
    public boolean compare(char c1, char d1){return d1 == '.' || c1 == d1;} 
