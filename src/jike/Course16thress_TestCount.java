...
public class Course16thress_TestCount {
	private Course16three_CountNode<Integer> countNode;
	@Before
	public void init(){
		countNode=new Course16three_CountNode<Integer>();
	}
	@Test
	public void testCount01(){
		Integer[] array={8,9,5,null,1,7};
		TreeNode<Integer> root=Course16two_CreateBinaryTree.arrayToBinaryTree(array, null);
